 ...
 * @author Diego
 */
public final class ControleJtextFieldSomenteLetras extends JTextField {

    private int maximoCaracteres = -1;// definição de -1 
// como valor normal de um textfield sem limite de caracters

    public ControleJtextFieldSomenteLetras() {
        super();
    ...
    public ControleJtextFieldSomenteLetras(int maximo) {
        super();
